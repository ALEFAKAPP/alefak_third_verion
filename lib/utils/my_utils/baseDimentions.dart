...
class D {
  ///**** Font Sizes */
  static final h1 = 17.sp*(Constants.DEVICE_RATIO>1.6?1:0.7);
  static final h2 = 15.sp*(Constants.DEVICE_RATIO>1.6?1:0.7);
  static final h3 = 13.sp*(Constants.DEVICE_RATIO>1.6?1:0.7);
  static final h4 = 12.sp*(Constants.DEVICE_RATIO>1.6?1:0.7);
  static final h5 = 10.sp*(Constants.DEVICE_RATIO>1.6?1:0.7);
  static final h6 = 9.sp*(Constants.DEVICE_RATIO>1.6?1:0.7);
