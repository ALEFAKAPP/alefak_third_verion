...
class _CategoryListState extends State<CategoryList> {
  ...
  void _onItemClick(int index){
    if(widget.categoriesProviderModel!.categoriesList[index].id==-1){
      ...
      MyUtils.navigate(widget.ctx, ServiceProviderListScreen(widget.categoriesProviderModel!.categoriesList[index].id??0,widget.categoriesProviderModel!.categoriesList[index].name!));
    }
  }
